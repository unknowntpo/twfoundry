  ...
  chunks: [
    {
      ...
      staticFeatures: [
        { id: 'station-anchor-R11-G14', ontologyObjectId: 'station-R11-G14', kind: 'station-anchor', geometry: { type: 'Point', coordinates: [0, 0.35, 0] }, visualState: { color: '#E16B8C', categoryLabel: 'MRT' } },
        { id: 'building-shin-kong-nanxi', ontologyObjectId: 'landmark-shin-kong-nanxi', kind: 'department-store', geometry: { type: 'Point', coordinates: [-2.8, 0, -2.2] }, visualState: { floors: 5, width: 1.6, depth: 1.3, color: '#F596AA', accentColor: '#F596AA', signColor: '#FFB11B', categoryLabel: 'DEPT', sign: true } },
        { id: 'building-eslite-nanxi', ontologyObjectId: 'landmark-eslite-nanxi', kind: 'bookstore-mall', geometry: { type: 'Point', coordinates: [2.4, 0, -2.0] }, visualState: { floors: 4, width: 1.45, depth: 1.1, color: '#FFD2DC', accentColor: '#FFD2DC', signColor: '#81C7D4', categoryLabel: 'BOOK', sign: true } },
        { id: 'building-linsen-lane', ontologyObjectId: 'landmark-linsen-lane-shop', kind: 'lane-shop', geometry: { type: 'Point', coordinates: [4.2, 0, 2.6] }, visualState: { floors: 3, width: 1.1, depth: 1.2, color: '#F8DDE7', accentColor: '#FFD2DC', signColor: '#B5CAA0', categoryLabel: 'LANE', sign: false } },
        { id: 'building-chifeng-maker', ontologyObjectId: 'landmark-chifeng-maker-lane', kind: 'lane-shop', geometry: { type: 'Point', coordinates: [-4.4, 0, 2.8] }, visualState: { floors: 2, width: 1.0, depth: 1.0, color: '#F3E5DA', accentColor: '#FFD2DC', signColor: '#E16B8C', categoryLabel: 'LANE', sign: false } },
      ],
      semanticZones: [
  ...
  objects: [
    {
      ...
      status: 'normal',
      summary: 'Fallback fixture：測試捷運站 ontology object 與 MRT 出入口 voxel render module。',
      properties: { overlay: 'mrt', stationId: 'R11/G14', lineId: 'red-green', intendedSource: 'tdx' },
