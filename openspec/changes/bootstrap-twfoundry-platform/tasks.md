...
- [ ] Create or link the Figma design source for Requirement: Figma Design Source.
...
- [ ] Record Figma design reference in project documentation after a shareable file exists.
