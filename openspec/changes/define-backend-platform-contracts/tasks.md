...
- [x] Resolve current-state storage direction as latest-state plus bounded timeline snapshot history.
...
- [x] Add local infrastructure notes or compose files for Kafka and StarRocks after backend work begins.
...
- [x] Preserve backend and frontend contract extensibility for both 2D and 3D map views.
- [x] Replace the MapLibre demo-tile basemap with a free Taiwan-capable default basemap and keep the style configurable.
